                ...
                <header class="flex justify-between items-center py-4 px-6 bg-white border-b-4 border-indigo-600">
                    <div class="flex items-center">
                        <button class="text-gray-500 focus:outline-none lg:hidden" @click="sidebarOpen = true">
                            <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path d="M4 6H20M4 12H20M4 18H11" stroke="currentColor" stroke-linecap="round"
                    ...
                    <div class="flex items-center">
                        <div class="relative" x-data="{ notificationOpen: false }">
                            ...
                            <div v-show="notificationOpen" class="fixed inset-0 h-full w-full z-10"
                        ...
                        <div class="relative">
                            ...
                            <div v-show="dropdownOpen" class="fixed inset-0 h-full w-full z-10"
