...
class GenreController extends Controller
{
    ...
    {
        $tmdb_genres = Http::get(
            config('services.tmdb.endpoint').
            'genre/movie/list?api_key='.config('services.tmdb.secret').
            '&language=en-US'
        );
        ...
        if ($tmdb_genres->successful()) {
            ...
            return Redirect::back()->with('flash.banner', 'Genre Generated');
        }
    ...
    public function destroy(Genre $genre)
    {
        ...
        return Redirect::back()->with('flash.banner', 'Genre Deleted')->with(
            'flash.bannerStyle',
            'danger'
        );
    }
