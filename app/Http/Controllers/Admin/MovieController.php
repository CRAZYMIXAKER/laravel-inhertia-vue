...
class MovieController extends Controller
{
    ...
    {
        $movie = Movie::where('tmdb_id', Request::input('movieTMDBId'))
            ->exists();
        ...
        $apiMovie = Http::asJson()->get(
            config('services.tmdb.endpoint').'movie/'.
            Request::input('movieTMDBId').
    ...
    public function destroy(Movie $movie)
    {
        ...
        return Redirect::back()->with('flash.banner', 'Movie Deleted')->with(
            'flash.bannerStyle',
            'danger'
        );
    }
